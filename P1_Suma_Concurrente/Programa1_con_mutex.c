/*
 * Programa 1 con mutex de la práctica 1 de Cómputo Concurrente
 *
...
pthread_mutex_t mutex; // Declaración del candado
...
/*
 * Función que calcula la suma desde 1 hasta N con hilos con MUTEX
 */
void *sumaParcial(void *ptr) {
  ...
  /* Se calcula la suma con candados */
